...
- [Análise de Similares](#análise-de-similares)
- [Público-alvo](#público-alvo)
- [Personas](#personas)
- [Escopo](#escopo)
- [Lista de requisitos e restrições](#lista-de-requisitos-e-restrições)
- [Documentação técnica](#documentação-técnica)
- [Lista de requisitos e funcionalidades](#lista-de-requisitos-e-funcionalidades)
- [Descritivo de requisitos e funcionalidades](#descritivo-de-requisitos-e-funcionalidades)
- [Lista de eventos](#lista-de-eventos)
- [Diagrama de contexto](#diagrama-de-contexto)
- [DFD nível 0](#dfd-nível-0)
